...
## Current task
Stage 05 and stages 24–31 now have executable typed authority adapters. Stage 32 has a subject-free rest/source-preservation measurement engine, but its admission policy remains intentionally unbound. The next scientific seam is a frozen subject-free calibration preregistration: exact overlap RGBA replay, visible DIRECT_SOURCE-only provenance, alpha/coverage preservation and silhouette-edge discrimination must be calibrated without Knight or Mage outcomes. Only after that calibration may Stage 32 become an admission gate and motion Stage 33 open.
