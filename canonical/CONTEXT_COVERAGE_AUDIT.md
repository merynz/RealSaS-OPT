...
> Bootstrap status: `BOOTSTRAP_AUDIT_CLOSED`
...
| `__tmp_invalid_do_not_use` | `6d2e926892c2` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `compiler-runtime-migration-audit-20260901` | `3267b3f1ec16` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `exp/arachne-skintokens-cleanroom-fit1-20260908` | `d0b666725e79` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `exp/geppetto-ar01-skeleton-causal-v1-20260907` | `58ea876d3e61` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `exp/lossless-rigging-evidence-v1-20260906` | `d840d96ece57` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `first-family-fit/v1-20260904` | `d8ba99dd4fe0` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `first-family-fit/v1-20260904-debugtmp` | `953f2ded4911` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `first-family-fit/v1-20260904-diag-scratch` | `953f2ded4911` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `first-family-fit/v1-20260904-work` | `953f2ded4911` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `first-fit-base/main-20260904` | `1f1d8b5bd0df` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `geppetto-r6-teacher-projection-port-20260901` | `bfa51e74be02` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `hardening/pre-fit-closure-v1-20260904` | `d4da94279e1f` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `main` | `244c5ab2c9db` | `CANONICAL` | canonical branch |
...
| `next/depth-bridge-route-correction-20260829` | `dcce855b0c93` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `next/m4-grid-prereg-20260829` | `f26fd2837619` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `next/proxy-evaluator-restoration-20260829` | `8f3d288c10de` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `product/mage-fit1-demo-fulfillment-20260914-role-fix-tmp` | `7ca58068d58e` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `product/mage-fit1-v5-p1-demo-20260913` | `2800a22df414` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `redteam-hardening-20260920` | `44a5241fa3ec` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `repair/stage14-policy-v2-20260920` | `76736ef05059` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `research/stage14-gsa-v2-downstream-audit-20260919` | `68eb6d2bb3ca` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `restoration/compiler-runtime-promotion-v1-20260903-export-v2-safety2` | `2eb09fe3e8c6` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `restoration/compiler-runtime-promotion-v1-20260903-export-v2-safety3` | `579a8697d7e3` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `restoration/compiler-runtime-promotion-v1-20260903-motion-bake-backup` | `b46a39b7f1e7` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `restoration/compiler-runtime-promotion-v1-20260903-p0-directional-binding` | `f0ce10051b4a` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
| `restoration/compiler-runtime-promotion-v1-20260903-stage1-backup` | `2b5d46718683` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `runtime-v4-p0-p1-20260917` | `e6654c065699` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
...
| `tooling/export-frozen-source-7f39` | `43a1e5b2376f` | `EVIDENCE_ONLY_UNREGISTERED` | safe default under branch authority policy |
