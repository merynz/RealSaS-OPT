...
> State fingerprint: `4b400a2267ddc0ea86dfb66d9ac6abc6074733456a1c4ced9e0fd160ff11bcd8`
...
|---|---|---|---|---|---|
| `V2_IMPLEMENTATION_ASSEMBLY` | `ACTIVE__WITNESS_EXECUTION_FORBIDDEN_UNTIL_READINESS_SEAL` | `main` | `c90733c389a7` | Can the 46-stage RealSaS V2 DAG be made internally complete, adversarially audited and executable with geometry, mechanics and appearance as co-equal product authorities before any Knight outcome is observed? | Knight product pass; unseen generalization; learned appearance quality; source-view cardinality reduction |
...
|---|---|---|
| `main` | `c90733c389a7` | canonical continuation branch |

### EVIDENCE_ONLY

| Branch | Head | Classification reason |
|---|---|---|
| `fit2/mage-full-subject-reclosure` | `eb7a20eb9da7` | historical/scoped Mage FIT2 evidence |
| `playback-stack-v1-20260916` | `46aaad438780` | historical generic-implementation donor and diagnostics |
| `repair/mage-full-subject-reclosure-20260912` | `2fa5d4b604d5` | historical transition provenance |
...
| `do-not-use` | `91b4593d5b2a` | observed live; not explicitly registered active |
| `dummy-unused` | `3609f2cc0cfc` | observed live; not explicitly registered active |
| `e2e/mage-scene-first-v1-20260905` | `c6b5108f672b` | observed live; not explicitly registered active |
| `e2e/mage-scene-first-v1-20260905-audit-temp` | `91b4593d5b2a` | observed live; not explicitly registered active |
| `exp/arachne-a1-v7-native-fit1-20260911` | `80bdde251f6c` | observed live; not explicitly registered active |
| `exp/arachne-skintokens-cleanroom-fit1-20260908` | `d0b666725e79` | observed live; not explicitly registered active |
...
| `exp/geppetto-ar01-skeleton-causal-v1-20260907` | `58ea876d3e61` | observed live; not explicitly registered active |
| `exp/geppetto-reference-strength-fullstack-v1-20260907` | `e6cc31ed13fc` | observed live; not explicitly registered active |
| `exp/lossless-rigging-evidence-v1-20260906` | `d840d96ece57` | observed live; not explicitly registered active |
...
| `first-family-fit/v1-20260904-debugtmp` | `953f2ded4911` | observed live; not explicitly registered active |
| `first-family-fit/v1-20260904-diag-scratch` | `953f2ded4911` | observed live; not explicitly registered active |
...
| `product/mage-fit1-v5-p1-demo-20260913` | `2800a22df414` | observed live; not explicitly registered active |
...
- main is the sole continuation and execution branch.
