...
ALLOWED = {
    "KEEP","KEEP_ADAPT","KEEP_QUALIFY","PORT_REBIND","PORT_QUALIFY","PORT_ADAPT",
    "BUILD","BUILD_ADAPT","BUILD_FIX","BUILD_SELECTIVE_PORT","BUILD_PROMOTE_IF_NEEDED",
    "BUILD_AFTER_SOURCE_GATE","FIX","FIX_BLOCKING","FIX_QUALIFY","KEEP_BUILD_BRIDGE",
    "DEFER_CONDITIONAL"
}
...
def main() -> None:
    ...
    print(f"PASS completion matrix rows={len(rows)} dependencies=valid optimizer=blocked")
