...
def main() -> None:
    ...
    ap.add_argument("--anchor-stride", type=int, default=DEFAULT_STRIDE)
    ap.add_argument("--depth-bins", type=int, default=DEFAULT_DEPTH_BINS)
    ...
    ap.add_argument("--historical-p95-norm-goal", type=float, default=0.05)
