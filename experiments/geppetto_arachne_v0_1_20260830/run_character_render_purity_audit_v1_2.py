...
def main() -> None:
    ...
    result = {
        "schema": "RealSaS.GeppettoArachne.CharacterRenderPurityAudit.v1.2",
        "status": status,
        ...
        "authority": {
            ...
            "render_authority": "master/assets/<asset>/renders/V0..V7/raster_authority.npz; native 1024 raster authority; cel_clean_512.png existence only in V1.2",
    ...
    jp = outdir / "CHARACTER_RENDER_PURITY_AUDIT_RESULT_V1_2.json"
    mp = outdir / "CHARACTER_RENDER_PURITY_AUDIT_REPORT_V1_2.md"
