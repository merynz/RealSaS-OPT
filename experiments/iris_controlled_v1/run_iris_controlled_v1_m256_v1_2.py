...
DENSE_MATCHER_SHA='6d70c42439e82fc02a4893e49965d206d02a05bd6d505fb42904f2a5b9fd4248'
DENSE_EVAL_SHA='ba24f0a5b010f29c793c0a9eabbde02892a7c7841937c54babd634ee3d8e1f6b'
...
def verify(pkg):
    checks={
      ...
      'iris_dense_matcher_v1.py':DENSE_MATCHER_SHA,
      'evaluate_iris_dense_matcher_v1.py':DENSE_EVAL_SHA,
    }
    bad=[]
...
def main():
    ...
    run_dir=root/'runs'/'IRIS_CONTROLLED_V1_M256_V1_1'; run_dir.mkdir(parents=True,exist_ok=True)
    ...
    run([sys.executable,pkg/'evaluate_iris_dense_matcher_v1.py','--cache-manifest',manifest,'--checkpoint',init,'--out',init_eval])
    ...
    run([sys.executable,pkg/'evaluate_iris_dense_matcher_v1.py','--cache-manifest',manifest,'--checkpoint',best,'--out',best_eval])

    I=json.load(open(init_eval))['TUNE']; B=json.load(open(best_eval))['TUNE']
