...
EXPECTED_REP_SEED_SHA='f3d43da7766f104cab08f19fd24b515d54fde47545cc3288da023779c6d4c9af';EXPECTED_MEMBERSHIP_SHA='ef19120e2cc98fac50a0c94ba863fd3cc4cec4a8392b9c48684f96ffeba3ba50';EXPECTED_PANEL_DIGEST='366b5fffb1ff93c1c7bbad0ac4746c4f2675a633ec01745c026cecb2b7820961';ROLE_COUNTS={'FIT_TRAIN':128,'FIT_SELECT':32,'TUNE_FINAL':26}
...
def main():
 ...
 if sha256_file(a.membership)!=EXPECTED_MEMBERSHIP_SHA:raise RuntimeError('mini membership SHA drift')
 capacity=verify_gpu(a.gpu_preflight_json);scripts=script_hashes(here)
 if scripts['MINI_EXTRACTABILITY_MEMBERSHIP_V1.json']!=EXPECTED_MEMBERSHIP_SHA:raise RuntimeError('bundled membership drift')
