...
def main():
 ...
 cmd([sys.executable,here/'train_pv5_r256_8x2_v1.py','--cache-manifest',cm,'--out-dir',train]); dec=train/'P_V5_R256_8X2_DECISION.json'; d=json.load(open(dec));
 ...
 tmp.mkdir()
 for p in (cpu,gpu,work/'PREOPT_AUTHORITY.json',work/'RUN_COMPLETE_P_V5_R256_8X2_V1.json',dec,train/'BEST_CHECKPOINT.pt',train/'TRAIN_AUTHORITY.json',train/'TRAIN_HISTORY.json',prereg,mem): shutil.copy2(p,tmp/p.name)
