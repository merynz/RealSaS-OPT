...
def main():
 ...
 for epoch in range(1,EPOCHS+1):
  ...
  for bi,batch in enumerate(loader,1):
   ...
   parts=total_loss(outputs,batch,epoch=epoch-1,warmup_epochs=WARMUP_EPOCHS);loss=parts['total']/GRAD_ACCUM
