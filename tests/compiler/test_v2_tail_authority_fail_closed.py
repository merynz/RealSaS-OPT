...
def test_dynamic_motion_v2_decoder_rejects_mechanical_and_frame_drift():
    frame = CanonicalDynamicFrameV2IR(
        ...
        total_self_intersection_pair_count=0,
...
def test_dynamic_visual_integrity_decoder_rejects_quality_metric_drift():
    value = DynamicVisualIntegrityV2IR(
        ...
        maximum_frame_compiled_unobserved_visible_fraction=0.1,
        maximum_connected_compiled_unobserved_visible_fraction=0.05,
        maximum_frame_micro_visible_pixel_fraction=0.0,
        consequential_visible_face_count=24,
        unmeasurable_consequential_visible_face_count=0,
        exact_depth_ambiguous_pixel_count=0,
        exact_depth_ambiguous_fraction=0.0,
        maximum_frame_exact_depth_ambiguous_fraction=0.0,
        visibility_layer_overflow_pixel_count=0,
        visible_orientation_flip_face_count=0,
